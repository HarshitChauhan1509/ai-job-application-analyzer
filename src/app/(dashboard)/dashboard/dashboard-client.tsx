...
export default function DashboardClient({ stats, recentApplications }: { stats: any, recentApplications: any[] }) {
  return (
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Uploaded and analyzed</p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold">{stats.jobsCount}</div>
            <p className="text-xs text-muted-foreground mt-1">Target opportunities</p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold">{stats.activeApplicationsCount}</div>
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold">{stats.upcomingInterviewsCount}</div>
            <p className="text-xs text-muted-foreground mt-1">Check schedule</p>
          </CardContent>
        </Card>
      </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <div className="space-y-1">
                ...
                <CardDescription>Your latest tracked opportunities</CardDescription>
              </div>
              <Link href="/applications" className="text-sm text-primary hover:underline flex items-center">
